...
class Category
{
    ...
    public function __construct()
    {
        ...
        $this->json = new Json();
        // ArticlePublish 클래스는 선택적으로 사용
        if (class_exists('Kodes\Wcms\ArticlePublish')) {
            $this->articlePublish = new ArticlePublish();
        } else {
            $this->articlePublish = null;
        }
    ...
    public function list($type = '')
    {
        ...
        $isUse = isset($_GET['isUse']) && $_GET['isUse'] != "" ? ($_GET['isUse'] == "1" ? true : false) : null;
